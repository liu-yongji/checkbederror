...
string sHelp = "Usage: ./vcfSnp2bed input_VCF_file/input_VCF_folder  output_folder  reference_rs_folder \n";
string sExample = "Example: ./vcfSnp2bed ./chr1.vcf ./ ./all_GRCh38_vcfs/ \n";
